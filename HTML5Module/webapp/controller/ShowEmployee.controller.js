sap.ui.define([
	...
	function onRiseEmployee(oEvent){
		if(!this.riseDialog){
            //this.riseDialog = sap.ui.xmlfragment("hrolltfg/hroll/fragment/RiseEmployee", this);
			this.riseDialog = sap.ui.xmlfragment("hrolltfg/hroll/HTML5Module/fragment/RiseEmployee", this);
	...
	return Controller.extend("hrolltfg.hroll.HTML5Module.controller.ShowEmployee", {
		onInit: onInit,
